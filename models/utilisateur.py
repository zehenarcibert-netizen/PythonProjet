...
class utilisateur:
    """Representa un utilisateur du systemen avec sont role"""

    roles= ["administrate" , "enseignant","agent"]
    _compteur = 0

    def __init__(self,nom:str,prenom:str,email:str,mot_de_passe:str,role:str="enseignant"):
        ...
        def set_actif(self, v):
            self.__actif = v

        # --- Permissions ---
        def peut_gerer_salles(self) -> bool:
            return self.__role in ["administrate", "agent"]

        def peut_gerer_utilisateurs(self) -> bool:
            return self.__role == "administrate"
